...
sprites, colors, _ = extract_sprites(f"{PATH}sprites.png", SPRITE_SIZE)

print(f"Unique sprites found: {len(sprites)}")
np.savez_compressed(f"{PATH}anim{SPRITE_SIZE}x{SPRITE_SIZE}.npz", sprites=sprites, colors=colors)
